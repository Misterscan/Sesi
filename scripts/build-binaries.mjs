...
try {
  execSync(
    'npx esbuild bin/sesi.js --bundle --platform=node --alias:node:sqlite=./mock-sqlite.js --external:blessed --external:playwright --external:playwright-core --external:chromium-bidi --external:term.js --external:pty.js --external:node-wav --external:smart-whisper --external:nodejs-whisper --external:onnxruntime-node --external:sharp --outfile=dist/sesi.bundled.js',
