...
```sesi
let original = "  Hello, Sesi V1.7.5!  "

let cleaned = trim(original)                   // "Hello, Sesi V1.7.5!"
let shouted = to_upper(cleaned)                // "HELLO, SESI V1.7.5!"
let part = slice(cleaned, 7, 11)               // "Sesi"
let replaced = swap(cleaned, " ", "_")         // "Hello,_Sesi_V1.7.5!"
